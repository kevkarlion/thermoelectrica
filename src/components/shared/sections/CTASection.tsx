...
const CTASection = () => {
  ...
  return (
    ...
    "
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl p-10 border border-gray-700/60 text-white">
  ...
  <form className="space-y-6">
    ...
    <div>
      ...
      >
        ...
        <option value="hvac" className="bg-gray-800">HVAC / Climatización</option>
        <option value="industrial" className="bg-gray-800">Refrigeración Industrial</option>
        <option value="precision" className="bg-gray-800">Refrigeración de Precisión</option>
        <option value="ammonia" className="bg-gray-800">Amoníaco (NH₃)</option>
        <option value="electricity" className="bg-gray-800">Electricidad Industrial</option>
        <option value="maintenance" className="bg-gray-800">Mantenimiento General</option>
      </select>
    </div>
